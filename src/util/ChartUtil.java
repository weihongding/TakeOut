...
public class ChartUtil {
	...
	public static Image getImage(int width, int height, double[] sampleValues) {
		// 下方显示的文字
		...
		// 把图例说明放在左侧
		chart.setLegendPosition(Chart.BELOW);
		// 图例说明中的文字
		chart.setLegendLabels(new String[] { "本月收入表" });
		// 图例说明的字体
	...
	public static void main(String[] args) {
		JPanel p = new JPanel();
		JLabel l = new JLabel();
		Image img = ChartUtil.getImage(400, 300, OrderService.getEarn(8));
